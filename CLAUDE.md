...
plugins/
  ...
  plan-runner/.claude-plugin/plugin.json     # manifest (v1.2.0)
...
plugins/                    # Root directory containing all plugins
  ...
  plan-runner/                # Plan-driven parallel agent orchestrator (v1.2.0)
    .claude-plugin/
