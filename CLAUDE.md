...
| `plan-runner` | 1.12.0 | Dual-client Claude Code and Codex plan executor with portable bundled-role loading: file-disjoint parallel waves, TDD gates, configurable independent verification, honest token/coverage accounting, bug-driven fix-plan re-runs, optional Code Atlas sync, and structured pull requests. Codex uses native subagents; Claude Code can additionally opt into Agent Teams. Sourced externally from [github.com/MisterVitoPro/plan-runner](https://github.com/MisterVitoPro/plan-runner). |
