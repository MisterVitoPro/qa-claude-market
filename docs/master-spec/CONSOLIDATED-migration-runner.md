# Consolidated Spec: migration-runner
...
<!-- source: plugins/migration-runner/docs/2026-05-03-migration-runner-design.md -->
## 2026-05-03-migration-runner-design
...
<!-- source: plugins/migration-runner/docs/2026-05-03-migration-runner-implementation-plan.md -->
## 2026-05-03-migration-runner-implementation-plan
...
<!-- source: plugins/migration-runner/README.md -->
## README
...
- **migration-detector** (`plugins/migration-runner/agents/migration-detector.md`) - Reports outdated dependencies for ONE ecosystem (npm, python, go, rust, java, kotlin, csharp) <!-- TODO: expand -->
- **migration-planner** (`plugins/migration-runner/agents/migration-planner.md`) - Converts detector output to wave-ordered upgrade plan, queries OSV.dev for CVEs, applies version-ranker <!-- TODO: expand -->
- **migration-applier** (`plugins/migration-runner/agents/migration-applier.md`) - Applies single package upgrade for one wave via ecosystem adapter <!-- TODO: expand -->
- **migration-verifier** (`plugins/migration-runner/agents/migration-verifier.md`) - Runs ecosystem verify commands (build, typecheck, tests) after wave upgrade, reports pass/fail <!-- TODO: expand -->
- **migration-runner:detect** (`plugins/migration-runner/skills/detect/SKILL.md`) - Scan for outdated dependencies across 7 ecosystems, query OSV.dev, produce vulnerability-aware plan <!-- TODO: expand -->
- **migration-runner:run** (`plugins/migration-runner/skills/run/SKILL.md`) - Execute upgrade plan wave-by-wave with verification, hard reset to pre-wave SHA on failure <!-- TODO: expand -->
- **SessionStart** (`plugins/migration-runner/hooks/hooks.json`) - Ensures .migration-runner/ is in .gitignore for cache, state, and logs <!-- TODO: expand -->
- **plan.schema.json** (`plugins/migration-runner/schemas/plan.schema.json`) - JSON schema for upgrade plan structure <!-- TODO: expand -->
- **state.schema.json** (`plugins/migration-runner/schemas/state.schema.json`) - JSON schema for migration state cache <!-- TODO: expand -->
- **applier-output.schema.json** (`plugins/migration-runner/schemas/applier-output.schema.json`) - JSON schema for applier agent output <!-- TODO: expand -->
- **verifier-output.schema.json** (`plugins/migration-runner/schemas/verifier-output.schema.json`) - JSON schema for verifier agent output <!-- TODO: expand -->
- **detector-output.schema.json** (`plugins/migration-runner/schemas/detector-output.schema.json`) - JSON schema for detector agent output (outdated list per ecosystem) <!-- TODO: expand -->
- **keywords** (`plugins/migration-runner/.claude-plugin/plugin.json`) - Non-default field: array of 14 keywords (dependency-management, vulnerability-scanning, etc.) <!-- TODO: expand -->
- **repository** (`plugins/migration-runner/.claude-plugin/plugin.json`) - Non-default field: GitHub repository URL <!-- TODO: expand -->
